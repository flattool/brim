# Brim Code of Conduct
The Brim project follows the [GNOME Code of Conduct](https://conduct.gnome.org/). A short summary of it goes like this:

The Brim project is dedicated to providing a positive experience to everyone, and does not accept inappropriate behaviour such as discrimination and hateful speech. We encourage everyone to keep a friendly tone, and to be constructive and civil.

## Reporting an Incident
If you believe someone is Violating the Code of Conduct, or have any other concerns, please contact lead developer Heliguy over [email](mailto:heliguy4599@hotmail.com).

## Our Standards
The Brim project is dedicated to providing a positive experience for everyone, regardless of:
...
We want all participants in the Brim project to have the best possible experience they can. In order to be clear about what that means, we’ve provided a list of examples of behaviors that are inappropriate for the Brim project:
...
The Brim project prioritizes marginalized people’s safety over privileged people’s comfort, for example in situations involving:
...
If a participant engages in behavior that violates this code of conduct, the Brim maintainers may take any action they deem appropriate.
